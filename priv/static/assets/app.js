...
`, template.innerHTML.trim());
  ...
  var Player = {
    ...
    getCurrentTime() {
      return Math.floor(this.player.getCurrentTime() * 1e3);
    },
    seekTo(millsec) {
      return this.player.seekTo(millsec / 1e3);
    }
  };
  ...
  var Video = {
    init(socket2, element) {
      ...
      socket2.connect();
      player_default.init(element.id, playerId, () => {
        this.onReady(videoId, socket2);
      });
    },
    onReady(videoId, socket2) {
      let msgContainer = document.getElementById("msg-container");
      let msgInput = document.getElementById("msg-input");
      let postButton = document.getElementById("msg-submit");
      let userList = document.getElementById("user-list");
      let lastSeenId = 0;
      let vidChannel = socket2.channel("videos:" + videoId, () => {
      ...
      postButton.addEventListener("click", (e) => {
        let payload = { body: msgInput.value, at: player_default.getCurrentTime() };
        vidChannel.push("new_annotation", payload).receive("error", (e2) => console.log(e2));
        msgInput.value = "";
      });
  ...
  `;
    ...
    scheduleMessages(msgContainer, annotations) {
      ...
      this.schedulerTimer = setTimeout(() => {
        let ctime = player_default.getCurrentTime();
  ...
  video_default.init(socket_default, document.getElementById("video"));
})();
/**
 * @license MIT
